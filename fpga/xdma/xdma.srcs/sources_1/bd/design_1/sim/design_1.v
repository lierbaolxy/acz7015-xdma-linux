...
(* CORE_GENERATION_INFO = "design_1,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=design_1,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=5,numReposBlks=5,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=1,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=2,da_board_cnt=6,da_clkrst_cnt=1,da_ps7_cnt=1,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "design_1.hwdef" *) 
module design_1
   (DDR_addr,
    DDR_ba,
    DDR_cas_n,
  ...
  assign diff_clock_rtl_0_1_CLK_N = ref_clk_clk_n[0];
  assign diff_clock_rtl_0_1_CLK_P = ref_clk_clk_p[0];
  assign pcie_mgt_txn[0] = xdma_0_pcie_mgt_txn;
  assign pcie_mgt_txp[0] = xdma_0_pcie_mgt_txp;
  assign reset_rtl_0_1 = rst_n;
  ...
  design_1_processing_system7_0_0 processing_system7_0
       (.DDR_Addr(DDR_addr[14:0]),
        ...
        .M_AXI_GP0_ACLK(xdma_0_axi_aclk),
        ...
        .S_AXI_HP0_ACLK(xdma_0_axi_aclk),
